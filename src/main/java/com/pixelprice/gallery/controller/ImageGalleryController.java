package com.pixelprice.gallery.controller;
...
import com.pixelprice.gallery.entity.ImageGallery;
import com.pixelprice.gallery.service.ImageGalleryService;
...
public class ImageGalleryController {
					...
					public @ResponseBody ResponseEntity<?>createProduct(@RequestParam("name")String name,@RequestParam("price") double price,@RequestParam("description") String description,
					...
					@ResponseBody
					public void showImage(@PathVariable("id") Long id, HttpServletResponse response,Optional<ImageGallery> imageGallery) throws ServletException,IOException {
